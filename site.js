(function () {
  const dictionary = {
    fr: {
      ...
      heroCopy: 'Le jeu de dating le plus frénétique : décisions rapides, profils absurdes, Quiz, Action ou Vérité, packs amis et Hall of Shame.',
      download: 'Télécharger',
      suggestCta: 'Suggérer une carte',
      featuresTitle: 'Quick decisions or game over',
      ...
      classicCopy: 'Swipe les red flags et green flags avant la fin du timer.',
      quizCopy: 'Vrai ou faux, 20 cartes, 50 cartes ou Max, avec records séparés.',
      partyCopy: 'Action ou Vérité, packs amis, votes locaux et récap clair.',
      collectionTitle: 'Build your legendary collection',
      collectionCopy: 'Le Hall of Fame et le Hall of Shame gardent la mémoire de tes meilleurs choix, de tes pires décisions et des cartes qui méritent une place au musée.',
      ...
      footer: '© Swipe Panic. Support : support@swipepanic.app · Signalement : report@swipepanic.app',
      ...
      copied: 'Suggestion copiée. Si votre mail ne s’ouvre pas, envoyez-la à suggest@swipepanic.app.',
      ...
      privacyIntro: "Swipe Panic est conçu pour fonctionner d'abord sur votre téléphone. Les scores, préférences, packs créés et signalements restent sur l'appareil sauf action volontaire de partage, d'export ou de signalement.",
      privacyLocalTitle: 'Données locales',
      privacyLocalCopy: "L'app peut stocker localement les réglages, records, packs amis, feedbacks de cartes et historique de collection. Ces données ne sont pas envoyées à une base cloud Swipe Panic.",
      ...
      privacyContactCopy: 'Questions privacy : privacy@swipepanic.app',
      ...
      reportEmailCopy: "Vous pouvez aussi écrire à report@swipepanic.app avec le nom du pack, son ID si disponible et les cartes concernées.",
      ...
      supportGeneralCopy: 'Support général : support@swipepanic.app',
      supportReportCopy: 'Signalement UGC : report@swipepanic.app',
      ...
      moderationContact: 'Contact modération : report@swipepanic.app',
    },
    en: {
      navHome: 'Home',
      navFeatures: 'Features',
      ...
      heroCopy: 'The most hectic dating game: quick decisions, absurd profiles, Quiz, Truth or Dare, friends packs and Hall of Shame.',
      download: 'Download',
      ...
      classicCopy: 'Swipe red flags and green flags before the timer runs out.',
      quizCopy: 'True or false, 20 cards, 50 cards or Max, with separate local records.',
      partyCopy: 'Truth or Dare, friends packs, local votes and a clean recap.',
      collectionTitle: 'Build your legendary collection',
      collectionCopy: 'Hall of Fame and Hall of Shame remember your best calls, worst decisions and museum-worthy cards.',
      ...
      footer: '© Swipe Panic. Support: support@swipepanic.app · Reports: report@swipepanic.app',
      ...
      copied: 'Suggestion copied. If your email app does not open, send it to suggest@swipepanic.app.',
      ...
      privacyIntro: 'Swipe Panic is designed to run first on your phone. Scores, preferences, created packs and reports stay on-device unless you intentionally share, export or report them.',
      privacyLocalTitle: 'Local data',
      privacyLocalCopy: 'The app may store settings, records, friends packs, card feedback and collection history locally. This data is not sent to a Swipe Panic cloud database.',
      ...
      privacyContactCopy: 'Privacy questions: privacy@swipepanic.app',
      ...
      reportEmailCopy: 'You can also email report@swipepanic.app with the pack name, its ID if available and the relevant cards.',
      supportTitle: 'Support',
      ...
      supportContactTitle: 'Contact',
      supportGeneralCopy: 'General support: support@swipepanic.app',
      supportReportCopy: 'UGC reports: report@swipepanic.app',
      ...
      moderationContact: 'Moderation contact: report@swipepanic.app',
    },
  };
  ...
  function wireSuggestion(lang) {
    ...
    form.addEventListener('submit', async (event) => {
      ...
      window.location.href = `mailto:suggest@swipepanic.app?subject=${encodeURIComponent(copy.suggestionSubject)}&body=${encodeURIComponent(text)}`;
    });
