(function () {
  ...
  "fr": {
    ...
    "ugcCreateTitle": "Crée ton propre jeu 🎨",
    "ugcCreateIntro": "Personnalisez vos soirées en créant des cartes directement dans l'application ! Voici comment faire en toute simplicité :",
    "ugcModeClassicTitle": "Mode Classic (Flags) 🚩/✅",
    "ugcModeClassicCopy": "Décrivez une situation amusante. Le jeu s'occupe de la classer en Green Flag 💚 ou Red Flag 💔.",
    "ugcModeQuizTitle": "Mode Quiz (Vrai/Faux) 🧠",
    "ugcModeQuizCopy": "Commencez votre phrase par '+' pour Vrai, ou '-' pour Faux (ex: '+ Le chocolat vient d'une plante').",
    "ugcModeSocialTitle": "Mode Party (Action/Vérité) 😈",
    "ugcModeSocialCopy": "Séparez l'action et la vérité par un trait vertical '|' (ex: 'Faire un mime | Révéler un secret').",
    "ugcShareTitle": "Partage Local Sans Cloud 📡",
    "ugcShareCopy": "Pas besoin de compte. Lancez une partie en Wi-Fi local comme Hôte : vos amis reçoivent temporairement votre pack sur leur téléphone. C'est privé, sécurisé et éphémère.",
  ...
  "en": {
    ...
    "ugcCreateTitle": "Create your own game 🎨",
    "ugcCreateIntro": "Customize your parties by creating cards directly in the app! Here is how to do it simply:",
    "ugcModeClassicTitle": "Classic Mode (Flags) 🚩/✅",
    "ugcModeClassicCopy": "Describe a fun situation. The game takes care of categorizing it as Green Flag 💚 or Red Flag 💔.",
    "ugcModeQuizTitle": "Quiz Mode (True/False) 🧠",
    "ugcModeQuizCopy": "Start your sentence with '+' for True, or '-' for False (ex: '+ Chocolate comes from a plant').",
    "ugcModeSocialTitle": "Party Mode (Truth/Dare) 😈",
    "ugcModeSocialCopy": "Separate action and truth with a vertical bar '|' (ex: 'Do a mime | Reveal a secret').",
    "ugcShareTitle": "Local Sharing Without Cloud 📡",
    "ugcShareCopy": "No account needed. Start a local Wi-Fi game as Host: your friends temporarily receive your pack on their phones. It's private, secure, and ephemeral.",
  ...
  "es": {
    ...
    "ugcCreateTitle": "Crea tu propio juego 🎨",
    "ugcCreateIntro": "¡Personaliza tus fiestas creando cartas directamente en la app! Aquí te explicamos cómo hacerlo de forma sencilla:",
    "ugcModeClassicTitle": "Modo Classic (Banderas) 🚩/✅",
    "ugcModeClassicCopy": "Describe una situación de citas divertida. El juego se encarga de clasificarla como Green Flag 💚 o Red Flag 💔.",
    "ugcModeQuizTitle": "Modo Quiz (Verdadero/Falso) 🧠",
    "ugcModeQuizCopy": "Empieza tu frase con '+' para Verdadero, o '-' para Falso (ej: '+ El chocolate viene de una planta').",
    "ugcModeSocialTitle": "Modo Party (Verdad o Reto) 😈",
    "ugcModeSocialCopy": "Separa el reto y la verdad con una barra vertical '|' (ej: 'Hacer una mímica | Revelar un secreto').",
    "ugcShareTitle": "Compartir Local Sin Cloud 📡",
    "ugcShareCopy": "No necesitas cuenta. Inicia una partida Wi-Fi local como Anfitrión: tus amigos reciben temporalmente tu pack en sus teléfonos. Es privado, seguro y efímero.",
  ...
  "de": {
    ...
    "ugcCreateTitle": "Eigene Karten erstellen 🎨",
    "ugcCreateIntro": "Passe deine Partys an, indem du Karten direkt in der App erstellst! So einfach geht's:",
    "ugcModeClassicTitle": "Classic-Modus (Flags) 🚩/✅",
    "ugcModeClassicCopy": "Beschreibe eine lustige Situation. Das Spiel ordnet sie als Green Flag 💚 oder Red Flag 💔 ein.",
    "ugcModeQuizTitle": "Quiz-Modus (Richtig/Falsch) 🧠",
    "ugcModeQuizCopy": "Beginne deinen Satz mit '+' für Richtig oder '-' für Falsch (z. B.: '+ Schokolade kommt von einer Pflanze').",
    "ugcModeSocialTitle": "Party-Modus (Wahrheit/Pflicht) 😈",
    "ugcModeSocialCopy": "Trenne Aktion und Wahrheit mit einem senkrechten Strich '|' (z. B.: 'Mime machen | Geheimnis verraten').",
    "ugcShareTitle": "Lokales Teilen ohne Cloud 📡",
    "ugcShareCopy": "Kein Konto erforderlich. Starte ein lokales WLAN-Spiel als Host: Deine Freunde erhalten deine Karten temporär auf ihr Handy. Privat, sicher und flüchtig.",
  ...
  "nl": {
    ...
    "ugcCreateTitle": "Maak je eigen kaarten 🎨",
    "ugcCreateIntro": "Pas je feestjes aan en maak rechtstreeks kaarten in de app! Zo doe je dat heel eenvoudig:",
    "ugcModeClassicTitle": "Classic-modus (Flags) 🚩/✅",
    "ugcModeClassicCopy": "Beschrijf een leuke situatie. De game deelt deze in als Green Flag 💚 of Red Flag 💔.",
    "ugcModeQuizTitle": "Quiz-modus (Waar/Niet waar) 🧠",
    "ugcModeQuizCopy": "Begin je zin met '+' voor Waar, of '-' voor Niet waar (bijv: '+ Chocolade komt van een plant').",
    "ugcModeSocialTitle": "Party-modus (Truth/Dare) 😈",
    "ugcModeSocialCopy": "Scheid actie en waarheid met een verticale streep '|' (bijv: 'Mime uitbeelden | Geheim onthullen').",
    "ugcShareTitle": "Lokaal delen zonder cloud 📡",
    "ugcShareCopy": "Geen account nodig. Start een game via lokale wifi als Host: je vrienden ontvangen je pack tijdelijk op hun telefoon. Het is privé, veilig en tijdelijk.",
  ...
  "pt": {
    ...
    "ugcCreateTitle": "Criar as tuas próprias cartas 🎨",
    "ugcCreateIntro": "Personaliza as tuas festas criando cartas diretamente na app! Eis como fazer de forma simples:",
    "ugcModeClassicTitle": "Modo Classic (Bandeiras) 🚩/✅",
    "ugcModeClassicCopy": "Descreve uma situação divertida. O jogo trata de a classificar como Green Flag 💚 ou Red Flag 💔.",
    "ugcModeQuizTitle": "Modo Quiz (Verdadeiro/Falso) 🧠",
    "ugcModeQuizCopy": "Começa a tua frase com '+' para Verdadeiro, ou '-' para Falso (ex: '+ O chocolate vem de uma planta').",
    "ugcModeSocialTitle": "Modo Party (Verdade ou Desafio) 😈",
    "ugcModeSocialCopy": "Separa a ação e a verdade por uma barra vertical '|' (ex: 'Fazer uma mímica | Revelar um segredo').",
    "ugcShareTitle": "Partilha Local Sem Cloud 📡",
    "ugcShareCopy": "Não precisas de conta. Inicia um jogo via Wi-Fi local como Anfitrião: os teus amigos recebem temporariamente o teu pacote nos seus telemóveis. É privado, seguro e efémero.",
