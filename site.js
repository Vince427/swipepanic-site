(function () {
  ...
  "fr": {
    ...
    "cl120changes": "<li>Mémoire de Groupe Local (« Mes Groupes ») : L'app mémorise automatiquement votre bande d'amis et le nombre de soirées jouées ensemble, sans compte ni cloud.</li><li>Rejouer en 1 clic : Bouton d'accès rapide sur l'accueil pour relancer directement une partie avec votre dernier groupe et le dernier pack joué.</li><li>Mini-Jeu Web Jouable &amp; Honnête : Jouez à Swipe Panic sur navigateur avec un consensus honnête, boutons adaptés aux modes et 6 langues complètes.</li><li>Rotation Quotidienne Déterministe : Nouvelle sélection quotidienne sans répétition pour le dilemme du jour et le défi hebdomadaire.</li><li>Générateur de Carrousels Sociaux : Outils de partage avec filtres de contenu stricts et liens trackés pour TikTok, Reels et Shorts.</li>",
  ...
  "en": {
    ...
    "cl120changes": "<li>Local Crew Memory (“My Crews”): The app automatically recognizes your local game group and counts your game nights together, without any cloud account.</li><li>1-Click Quick Replay: Instant shortcut on the home screen to resume a session with your last crew and pack.</li><li>Playable &amp; Honest Web Mini-Game: Play Swipe Panic in your browser with transparent consensus stats, adaptive mode buttons, and 6 full languages.</li><li>Deterministic Daily Rotation: Smarter card selection ensuring zero repeats for the daily dilemma and weekly challenge.</li><li>Social Carousel Generator: Shareable card exports with strict safety filters and tracked deep links for TikTok, Reels, and Shorts.</li>",
  ...
  "es": {
    ...
    "cl120changes": "<li>Memoria de Grupo Local («Mis Grupos»): La aplicación recuerda automáticamente a tu grupo de amigos y cuenta vuestras noches de juego juntos, sin cuentas ni nube.</li><li>Repetir en 1 clic: Acceso rápido en la pantalla de inicio para volver a jugar con tu último grupo y el último pack utilizado.</li><li>Mini-Juego Web Jugable y Honesto: Juega a Swipe Panic en el navegador con estadísticas de consenso transparentes y soporte completo para 6 idiomas.</li><li>Rotación Diaria Determinista: Selección inteligente de cartas sin repeticiones para el dilema diario y el desafío semanal.</li><li>Generador de Carruseles Sociales: Exportación de cartas con filtros estrictos de seguridad y enlaces para TikTok, Reels y Shorts.</li>",
  ...
  "de": {
    ...
    "cl120changes": "<li>Lokaler Gruppenspeicher („Meine Gruppen“): Die App merkt sich deine Spielrunde und zählt eure gemeinsamen Spieleabende, ganz ohne Cloud-Konto.</li><li>1-Klick-Schnellstart: Schneller Zugriff auf dem Startbildschirm, um direkt mit deiner letzten Gruppe und dem letzten Pack weiterzuspielen.</li><li>Spielbares &amp; ehrliches Web-Minispiel: Spiele Swipe Panic im Browser mit transparenten Konsens-Daten und voller 6-Sprachen-Unterstützung.</li><li>Deterministische tägliche Rotation: Verbesserte Kartenauswahl ohne Wiederholungen für das tägliche Dilemma und die Wochen-Challenge.</li><li>Social-Karussell-Generator: Exportierbare Karten mit strengen Sicherheitsfiltern und Links für TikTok, Reels und Shorts.</li>",
  ...
  "nl": {
    ...
    "cl120changes": "<li>Lokale Groepsherkenning (‘Mijn Groepen’): De app onthoudt automatisch je vriendengroep en telt jullie spelavonden samen, zonder cloud-account.</li><li>Opnieuw spelen in 1 klik: Snelle snelkoppeling op het startscherm om direct een potje te starten met je laatste groep en pack.</li><li>Speelbare &amp; Eerlijke Web Minigame: Speel Swipe Panic in je browser met transparante consensusstatistieken en 6 volledige talen.</li><li>Deterministische Dagelijkse Rotatie: Slimme kaartselectie zonder herhalingen voor het dagelijkse dilemma en de weekchallenge.</li><li>Sociale Carrousel Generator: Deelbare kaarten met strikte veiligheidsfilters en links voor TikTok, Reels en Shorts.</li>",
  ...
  "pt": {
    ...
    "cl120changes": "<li>Memória de Grupo Local («Os Meus Grupos»): A app memoriza automaticamente o teu grupo de amigos e conta as noites de jogo juntos, sem conta nem nuvem.</li><li>Jogar novamente em 1 clique: Atalho rápido no ecrã inicial para reiniciar uma sessão com o teu último grupo e pack.</li><li>Mini-Jogo Web Jogável e Transparente: Joga Swipe Panic no navegador com consenso honesto e suporte completo em 6 idiomas.</li><li>Rotação Diária Determinística: Seleção inteligente de cartas sem repetições para o dilema diário e o desafio semanal.</li><li>Gerador de Carrosséis Sociais: Exportação de cartas com filtros estritos de segurança e links para TikTok, Reels e Shorts.</li>",
